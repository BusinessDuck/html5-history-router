...
var Router = /** @class */ (function () {
    ...
    Router.prototype._onLocationChange = function (applied) {
        ...
        this._resolving = this._resolver(this._prevUrl, path).then(function (result) {
            if (result) {
    ...
    Router.prototype._revertState = function () {
        ...
        return this.pushState(this._prevUrl, __assign(__assign({}, this._prevState), { reverted: true }));
    };
    /**
     * Resolve location
     */
